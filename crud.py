...
def create_cc_account(cc_account_name, bonus_received,date_opened, last_owned, is_active, user_id, credit_card_id):
    ...
    cc_account = CreditCardAccount(cc_account_name=cc_account_name, bonus_received=bonus_received, date_opened=date_opened, last_owned=last_owned, is_active=is_active, user_id=user_id, credit_card_id=credit_card_id)
